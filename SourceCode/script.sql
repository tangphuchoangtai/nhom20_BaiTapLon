...
-- Insert dữ liệu
INSERT INTO `fashionstore`.`user` (`id`, `login_Type`, `role`, `password`, `user_Name`, `avatar`, `email`, `phone_Number`) VALUES ('quydat', 'default', 'user', 'MQ==', 'Quy Dat', 'https://haycafe.vn/wp-content/uploads/2022/02/Avatar-trang-den.png', 'quydat123@gmail.com', '0775668009');
INSERT INTO `fashionstore`.`user` (`id`, `login_Type`, `role`, `password`, `user_Name`, `avatar`, `email`, `phone_Number`) VALUES ('admin', 'default', 'admin', 'MQ==', 'Quy Dat', 'https://haycafe.vn/wp-content/uploads/2022/02/Avatar-trang-den.png', 'quydat213@gmail.com', '0775668009');
-- user name = quydat pass=1
